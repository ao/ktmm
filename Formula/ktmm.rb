class Ktmm < Formula
  ...
  if Hardware::CPU.arm?
    ...
    sha256 "7400df454b0f3cf3424ca4c8dda48d35c2620571b8857427abebdb6938c0721e"  # arm64
  else
    url "https://github.com/ao/ktmm/releases/download/v#{version}/ktmm-macos-x86_64"
    sha256 "0781ab4279e0d7311fdffcb97ff882547ea203cea4ce9adceea18b6be48149e3"  # x86_64
  end
